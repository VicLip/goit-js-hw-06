...
// Поэтому такой массив нужно заполнить значениями
...
// Преимущество создания массива заданной длины перед
// добавлением в пустой массив в том,
...
// по сравнению с использованием литерала.
